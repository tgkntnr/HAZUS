...
df_comb["COM1LossCntDC"]=df_comb["CDCCOM1"]*df_comb["COM1ContentDamage"]*df_comb["AreaInundated"]
df_comb["COM1LossCntVA"]=df_comb["CVCOM1"]*df_comb["COM1ContentDamage"]*df_comb["AreaInundated"]
df_comb["COM1LossCntM"]=df_comb["CMCOM1"]*df_comb["COM1ContentDamage"]*df_comb["AreaInundated"]
df_comb["COM1TotalCnt"]=df_comb["COM1LossCntDC"]+df_comb["COM1LossCntVA"]+df_comb["COM1LossCntM"]
####
df_comb["COM2LossCntDC"]=df_comb["CDCCOM2"]*df_comb["COM2ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM2LossCntVA"]=df_comb["CVCOM2"]*df_comb["COM2ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM2LossCntM"]=df_comb["CMCOM2"]*df_comb["COM2ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM2TotalCnt"]=df_comb["COM2LossCntDC"]+df_comb["COM2LossCntVA"]+df_comb["COM2LossCntM"]
###
df_comb["COM3LossCntDC"]=df_comb["CDCCOM3"]*df_comb["COM3ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM3LossCntVA"]=df_comb["CVCOM3"]*df_comb["COM3ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM3LossCntM"]=df_comb["CMCOM3"]*df_comb["COM3ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM3TotalCnt"]=df_comb["COM3LossCntDC"]+df_comb["COM3LossCntVA"]+df_comb["COM3LossCntM"]
####
df_comb["COM4LossCntDC"]=df_comb["CDCCOM4"]*df_comb["COM4ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM4LossCntVA"]=df_comb["CVCOM4"]*df_comb["COM4ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM4LossCntM"]=df_comb["CMCOM4"]*df_comb["COM4ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM4TotalCnt"]=df_comb["COM4LossCntDC"]+df_comb["COM4LossCntVA"]+df_comb["COM4LossCntM"]
###
df_comb["COM5LossCntDC"]=df_comb["CDCCOM5"]*df_comb["COM5ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM5LossCntVA"]=df_comb["CVCOM5"]*df_comb["COM5ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM5LossCntM"]=df_comb["CMCOM5"]*df_comb["COM5ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM5TotalCnt"]=df_comb["COM5LossCntDC"]+df_comb["COM5LossCntVA"]+df_comb["COM5LossCntM"]
###
df_comb["COM6LossCntDC"]=df_comb["CDCCOM6"]*df_comb["COM6ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM6LossCntVA"]=df_comb["CVCOM6"]*df_comb["COM6ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM6LossCntM"]=df_comb["CMCOM6"]*df_comb["COM6ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM6TotalCnt"]=df_comb["COM6LossCntDC"]+df_comb["COM6LossCntVA"]+df_comb["COM6LossCntM"]
###
df_comb["COM7LossCntDC"]=df_comb["CDCCOM7"]*df_comb["COM7ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM7LossCntVA"]=df_comb["CVCOM7"]*df_comb["COM7ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM7LossCntM"]=df_comb["CMCOM7"]*df_comb["COM7ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM7TotalCnt"]=df_comb["COM7LossCntDC"]+df_comb["COM7LossCntVA"]+df_comb["COM7LossCntM"]
####
df_comb["COM8LossCntDC"]=df_comb["CDCCOM8"]*df_comb["COM8ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM8LossCntVA"]=df_comb["CVCOM8"]*df_comb["COM8ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM8LossCntM"]=df_comb["CMCOM8"]*df_comb["COM8ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM8TotalCnt"]=df_comb["COM8LossCntDC"]+df_comb["COM8LossCntVA"]+df_comb["COM8LossCntM"]
###
df_comb["COM9LossCntDC"]=df_comb["CDCCOM9"]*df_comb["COM9ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM9LossCntVA"]=df_comb["CVCOM9"]*df_comb["COM9ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM9LossCntM"]=df_comb["CMCOM9"]*df_comb["COM9ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM9TotalCnt"]=df_comb["COM9LossCntDC"]+df_comb["COM9LossCntVA"]+df_comb["COM9LossCntM"]
###
df_comb["COM10LossCntDC"]=df_comb["CDCCOM10"]*df_comb["COM10ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM10LossCntVA"]=df_comb["CVCOM10"]*df_comb["COM10ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM10LossCntM"]=df_comb["CMCOM10"]*df_comb["COM10ContentWeigh"]*df_comb["AreaInundated"]
df_comb["COM10TotalCnt"]=df_comb["COM10LossCntDC"]+df_comb["COM10LossCntVA"]+df_comb["COM10LossCntM"]
###
df_comb['InventorylossVCOM1Py']=df_comb['SqVCOM1']*df_comb['COM1InventoryDamage']*81*df_comb['AreaInundated']*0.10
df_comb['InventorylossVCOM2Py']=df_comb['SqVCOM2']*df_comb['COM2InventoryDamage']*56*df_comb['AreaInundated']*0.13
###
df_comb['InventorylossMCOM1Py']=df_comb['SqMCOM1']*df_comb['COM1InventoryDamage']*81*df_comb['AreaInundated']*0.10
df_comb['InventorylossMCOM2Py']=df_comb['SqMCOM2']*df_comb['COM2InventoryDamage']*56*df_comb['AreaInundated']*0.13
###
df_comb['InventorylossDCCOM1Py']=df_comb['SqDCCOM1']*df_comb['COM1InventoryDamage']*81*df_comb['AreaInundated']*0.10
df_comb['InventorylossDCCOM2Py']=df_comb['SqDCCOM2']*df_comb['COM2InventoryDamage']*56*df_comb['AreaInundated']*0.13
##############################################################################################
df_comb["COM1TotalInv"]=df_comb['InventorylossMCOM1Py']+df_comb['InventorylossVCOM1Py']+df_comb['InventorylossDCCOM1Py']
df_comb["COM2TotalInv"]=df_comb['InventorylossDCCOM2Py']+df_comb['InventorylossMCOM2Py']+df_comb['InventorylossVCOM2Py']
###
COM1I=df_comb["COM1TotalInv"].sum()
COM2I=df_comb["COM2TotalInv"].sum()
###Content
COM1loss=df_comb["COM1TotalCnt"].sum()
COM2loss=df_comb["COM2TotalCnt"].sum()
COM3loss=df_comb["COM3TotalCnt"].sum()
COM4loss=df_comb["COM4TotalCnt"].sum()
COM5loss=df_comb["COM5TotalCnt"].sum()
COM6loss=df_comb["COM6TotalCnt"].sum()
COM7loss=df_comb["COM7TotalCnt"].sum()
COM8loss=df_comb["COM8TotalCnt"].sum()
COM9loss=df_comb["COM9TotalCnt"].sum()
COM10loss=df_comb["COM10TotalCnt"].sum()
###################33
#print(COM1loss*1000)
#print(COM2loss*1000)
#print(COM3loss*1000)
